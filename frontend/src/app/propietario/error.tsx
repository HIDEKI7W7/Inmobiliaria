...
export default function PropietarioError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => { console.error('[PropietarioError]', error.message); }, [error]);
  return (
    <div className="min-h-screen bg-[#0b0b0f] flex items-center justify-center p-6">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Error en el Panel del Propietario</h2>
        <p className="text-gray-400 text-sm mb-6 leading-relaxed">
          No pudimos cargar tu panel. Verifica tu conexión o intenta nuevamente.
        </p>

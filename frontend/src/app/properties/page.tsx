...
const ALL_PROPERTIES: EnhancedProperty[] = [
  {
    ...
    description: 'Espectacular penthouse de estreno con terraza panorámica, jacuzzi y acabados de primera. Suite principal con vestidor, Terraza privada con vista panorámica, Parqueo subterráneo techado.',
    price: 183908.0,
    priceBob: 1280000.0,
    area: 195.0,
    rooms: 4,
  ...
  },
  {
    ...
    description: 'Amplia casa de dos plantas con jardín interior, churrasquera y seguridad las 24 horas. Cocina remodelada, Jardín interior amplio, Churrasquero propio.',
    price: 318965.0,
    priceBob: 2220000.0,
    area: 250.0,
    rooms: 5,
  ...
  },
  {
    ...
    description: 'Departamento de estreno en pleno Prado. Iluminación LED inteligente, Conexión de Gas Domiciliario.',
    price: 93390.0,
    priceBob: 650000.0,
    area: 85.0,
    rooms: 2,
  ...
  },
  {
    ...
    description: 'Amplio galpón industrial en Villa Adela. Cerco eléctrico perimetral, Tanque de agua de gran capacidad, Generador eléctrico de emergencia.',
    price: 495689.0,
    priceBob: 3450000.0,
    area: 900.0,
    rooms: 0,
  ...
  },
  {
    ...
    description: 'Excelente terreno plano comercial sobre Av. Banzer. Lote Premium (en esquina, frente a área verde).',
    price: 270114.0,
    priceBob: 1880000.0,
    area: 600.0,
    rooms: 0,
  ...
  },
  {
    ...
    description: 'Precioso monoambiente totalmente equipado en Equipetrol. Seguridad de vigilancia 24/7, Piscina atemperada, Gimnasio equipado.',
    price: 459.0,
    priceBob: 3200.0,
    area: 42.0,
    rooms: 1,
  ...
  },
  {
    ...
    description: 'Oficina ejecutiva de alto nivel en zona central. Control de acceso biométrico, Circuito cerrado de cámaras, Coworking space.',
    price: 1077.0,
    priceBob: 7500.0,
    area: 110.0,
    rooms: 0,
  ...
  },
  {
    ...
    description: 'Local comercial amplio sobre Av. América. Iluminación LED inteligente, Chapas digitales / cerraduras inteligentes.',
    price: 1408.0,
    priceBob: 9800.0,
    area: 130.0,
    rooms: 0,
  ...
  },
  {
    ...
    description: 'Cómodo garzonier en zona San Roque. Conexión de Gas Domiciliario instalada.',
    price: 258.0,
    priceBob: 1800.0,
    area: 55.0,
    rooms: 1,
  ...
  },
  {
    ...
    description: 'Casa elegante en condominio privado. Churrasquero propio, Áreas de juegos infantiles, Seguridad de vigilancia 24/7.',
    price: 718.0,
    priceBob: 5000.0,
    area: 210.0,
    rooms: 3,
  ...
  },
  {
    ...
    description: 'Amplio departamento ideal para familias en Sarco. Parqueo doble, Baulera amplia, Conexión de Gas Domiciliario instalada.',
    price: 35201.0,
    priceBob: 245000.0,
    area: 120.0,
    rooms: 3,
  ...
  },
  {
    ...
    description: 'Moderno monoambiente de diseño minimalista en Sopocachi. Edificio pet-friendly, Control de acceso biométrico.',
    price: 15086.0,
    priceBob: 105000.0,
    area: 38.0,
    rooms: 1,
  ...
  },
  {
    ...
    description: 'Casa independiente cómoda en Oruro. Tanque de agua de gran capacidad, Jardín interior, Garaje amplio.',
    price: 45258.0,
    priceBob: 315000.0,
    area: 160.0,
    rooms: 4,
  ...
  },
  {
    ...
    description: 'Cómodo garzonier soleado en Ciudad Satélite. Calefón a gas o termotanque solar instalado.',
    price: 12931.0,
    priceBob: 90000.0,
    area: 50.0,
    rooms: 1,
  ...
  },
  {
    ...
    description: 'Oficina adaptada para consultorios en pleno centro. Iluminación LED inteligente, Chapas digitales / cerraduras inteligentes.',
    price: 20114.0,
    priceBob: 140000.0,
    area: 65.0,
    rooms: 0,
  ...
  },
  {
    ...
    description: 'Proyecto residencial en preventa en el Urubó. Club House, Piscina atemperada, Domótica, Aislamiento acústico y térmico.',
    price: 280172.0,
    priceBob: 1950000.0,
    area: 280.0,
    rooms: 4,
  ...
  },
  {
    ...
    description: 'Preventa de departamentos sostenibles en Tupuraya. Termotanque solar instalado, Iluminación LED inteligente, Coworking space.',
    price: 84770.0,
    priceBob: 590000.0,
    area: 78.0,
    rooms: 2,
  ...
  },
  {
    ...
    description: 'Inversión comercial de gran envergadura en Riberalta. Generador eléctrico de emergencia, Tanque de agua de gran capacidad, Circuito cerrado de cámaras (CCTV).',
    price: 833333.0,
    priceBob: 5800000.0,
    area: 1800.0,
    rooms: 25,
  ...
  },
  {
    ...
    description: 'Lotes comerciales en Cobija Oeste. Lote Premium (en esquina, frente a área verde).',
    price: 50287.0,
    priceBob: 350000.0,
    area: 500.0,
    rooms: 0,
  ...
  },
  {
    ...
    description: 'Edificio corporativo de oficinas premium en Sirari. Control de acceso biométrico, Circuito cerrado de cámaras, Parqueo para visitas en el edificio.',
    price: 1278735.0,
    priceBob: 8900000.0,
    area: 2400.0,
    rooms: 0,
